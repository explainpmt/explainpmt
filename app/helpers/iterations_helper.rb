module IterationsHelper
  def link_to_new_iteration
    link_to 'New Iteration', new_project_iteration_path(@project)
  end
  ...
  def link_to_edit_iteration(iteration, options={})
    link_to (options[:text] || iteration.name), edit_project_iteration_path(@project, iteration)
  end
  ...
  def link_to_assign_stories(iteration)
    link_to 'Assign Story Cards', select_stories_project_iteration_path(@project, iteration)
  end
  
  def link_to_allocation(iteration)
    link_to 'Allocation', allocation_project_iteration_path(@project, iteration)
  end
