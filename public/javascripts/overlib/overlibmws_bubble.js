...
var OLbubbleImages='roundcorners';
if(typeof OLbubbleImageDir=='undefined')var OLbubbleImageDir='/images';
OLregisterImages('roundcorners',OLbubbleImageDir);
var OLimgWidth=[250,330,144,189,200];
var OLimgHeight=[150,160,190,48,66];
var OLcontentWidth=[200,250,130,189,190];
var OLcontentHeight=[80,85,150,48,46];
var OLpadLeft=[30,40,7,9,5];
var OLpadTop=[25,48,10,14,4];
