...
if(OLud('modalcolor'))var ol_modalcolor="#333333";
if(OLud('modalopacity'))var ol_modalopacity=80;
// END CONFIGURATION

var o3_modal=0,o3_modalcolor="#333333",o3_modalopacity=80;
...
OLmTT=new Array("a","button","iframe","input","select","textarea"),OLmEdit=1;
...
if(OLie55){
	if(!OLgetRef('modalIframe')){OLmIframe=o3_frame.document.createElement('iframe');
...
OLmIframe.style.display='none';}OLmEdit=1;
}
